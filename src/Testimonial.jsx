    ...
    <section>
      ...
      >
        ...
        <svg
          ...
          className="w-8 h-8 text-[rgb(184,136,82)]  flex-shrink-0"
        >
        ...
        <div className="flex flex-col">
          <p className="text-sm font-bold text-[1.2rem]  text-center  bg-gradient-to-r from-blue-950 to-[rgb(184,136,82)] bg-clip-text text-transparent
                 before:from-blue-950 before:to-[rgb(184,136,82)]  leading-tight">{currentMessage}</p>
        </div>
      </div>
    </section>
  );
